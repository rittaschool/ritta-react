                        ...
                        <div class="row">
                          <div class="col-sm-3">
                            <ul>
                              ...
                              <li>
                                <i class="wi wi-day-sleet"></i>day-sleet
                              </li>
                              <li>
                                <i class="wi wi-day-haze"></i>day-haze
                              </li>
                              <li>
                          ...
                          <div class="col-sm-3">
                            <ul>
                              <li>
                                <i class="wi wi-moonrise"></i>moonrise
                              </li>
                              <li>
                                <i class="wi wi-moonset"></i>moonset
                              </li>
                              <li>
                                <i class="wi wi-night-sleet"></i>night-sleet
                              </li>
                              <li>
                              ...
                              <li>
                                <i class="wi wi-raindrop"></i>raindrop
                              </li>
                              <li>
                                <i class="wi wi-barometer"></i>barometer
                              </li>
                              <li>
                          ...
                          <div class="col-sm-3">
                            <ul>
                              <li>
                                <i class="wi wi-na"></i>na (no report)
                              </li>
                              <li>
                                <i class="wi wi-flood"></i>flood
                              </li>
                              <li>
                                <i class="wi wi-sandstorm"></i>sandstorm
                              </li>
                              <li>
                                <i class="wi wi-tsunami"></i>tsunami
                              </li>
                              <li>
                                <i class="wi wi-earthquake"></i>earthquake
                              </li>
                              <li>
                                <i class="wi wi-fire"></i>fire
                              </li>
                            </ul>
                          </div>
                          <div class="col-sm-3">
                            <ul>
                              <li>
                                <i class="wi wi-volcano"></i>volcano
                              </li>
                              <li>
                                <i class="wi wi-train"></i>train
                              </li>
                              <li>
                              ...
                              <li>
                                <i class="wi wi-gale-warning"></i>gale-warning
                              </li>
                              <li>
                                <i class="wi wi-storm-warning"></i>storm-warning
                              </li>
                              <li>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12 icon-set">
                        ...
                        <div class="row">
                          ...
                          <div class="icon-wrap">
                            <div class="icon">
                              <i class="wi wi-wind wi-from-nne"></i>
                            </div>
                          ...
                          <div class="icon-wrap">
                            <div class="icon">
                              <i class="wi wi-wind wi-from-ene"></i>
                            </div>
                          ...
                          <div class="icon-wrap">
                            <div class="icon">
                              <i class="wi wi-wind wi-from-e"></i>
                            </div>
                          ...
                          <div class="icon-wrap">
                            <div class="icon">
                              <i class="wi wi-wind wi-from-ese"></i>
                            </div>
                          ...
                          <div class="icon-wrap">
                            <div class="icon">
                              <i class="wi wi-wind wi-from-sse"></i>
                            </div>
                          ...
                          <div class="icon-wrap">
                            <div class="icon">
                              <i class="wi wi-wind wi-from-s"></i>
                            </div>
                          ...
                          <div class="icon-wrap">
                            <div class="icon">
                              <i class="wi wi-wind wi-from-ssw"></i>
                            </div>
