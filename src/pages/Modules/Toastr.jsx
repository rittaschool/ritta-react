              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <button class="btn btn-primary" id="toastr-1">
                      Launch
                    </button>
                  </div>
                </div>
              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <button class="btn btn-primary" id="toastr-2">
                      Launch
                    </button>
                  </div>
                </div>
              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <button class="btn btn-primary" id="toastr-3">
                      Launch
                    </button>
                  </div>
                </div>
              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <button class="btn btn-primary" id="toastr-4">
                      Launch
                    </button>
                  </div>
                </div>
              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <button class="btn btn-primary" id="toastr-5">
                      Launch
                    </button>
                  </div>
                </div>
              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <button class="btn btn-primary" id="toastr-6">
                      Launch
                    </button>
                  </div>
                </div>
              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <button class="btn btn-primary" id="toastr-7">
                      Launch
                    </button>
                  </div>
                </div>
              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <button class="btn btn-primary" id="toastr-8">
                      Launch
                    </button>
                  </div>
                </div>
