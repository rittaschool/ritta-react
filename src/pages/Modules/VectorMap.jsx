        ...
        <section class="section">
          ...
          <div class="section-body">
            ...
            <p class="section-lead">
              We use the 'jQuery Vector Map Library' plugin to create vector
              maps. This plugin is created by @manifestinteractive
            </p>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row align-items-center mb-4">
                      ...
                      <div class="col-6">
                        <span
                          class="flag-icon flag-icon-id flag-icon-shadow"
                          id="flag-icon"
                        ></span>
                      </div>
                    </div>
