                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="owl-carousel owl-theme slider" id="slider1">
                      <div>
                        <img alt="image" src="../assets/img/news/img01.jpg" />
                      </div>
                      <div>
                        <img alt="image" src="../assets/img/news/img08.jpg" />
                      </div>
                      <div>
                        <img alt="image" src="../assets/img/news/img10.jpg" />
                      </div>
                      <div>
                        <img alt="image" src="../assets/img/news/img09.jpg" />
                      </div>
                    </div>
                  </div>
                </div>
