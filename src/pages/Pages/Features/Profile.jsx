                      ...
                      <div class="row">
                        <div class="form-group col-12">
                          ...
                          <textarea class="form-control summernote-simple">
                            Ujang maman is a superhero name in Indonesia,
                            especially in my family. He is not a fictional
                            character but an original hero in my family, a hero
                            for his children and for his wife. So, I use the
                            name as a user in this template. Not a tribute, I'm
                            just bored with 'John Doe'.
                          </textarea>
                        </div>
                      </div>
                      <div class="row">
